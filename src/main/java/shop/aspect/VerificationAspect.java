...
public class VerificationAspect {
     ...
     */
    @Pointcut("execution(public * shop.controller.*.*Controller.*(..))")
    ...
    public void checkParameter(JoinPoint point) throws RequestException {
        // 获得切入方法参数
        ...
        for (Object o : argsWithoutNullable) {
            if (o == null) {
                throw new RequestException(RequestCommon.ERROR_PARAMETER);
            }
        }
    }
}
